...
<body>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark sidenav">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="historico_func.php" class="nav-link active">
                    Histórico
                </a>
        </ul>
        <hr>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
                <li><a class="dropdown-item" href="../website_funcionario/perfil_func.php">Ver Perfil</a></li>
    ...
    <div class="main">
        ...
        <form class="form-historico" action="historico_func.php" method="post">
